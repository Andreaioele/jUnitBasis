...
class BMICalculatorTest {
    ...
    //ex --> start db session, connection to server
    @BeforeAll
    ...
    //ex --> close db session, close connection to server
    @AfterAll
    ...
    @Nested
    @DisplayName("Sample inner class diplay name")
    class FindCoderWithWorstBMITests {

        @Test
        @DisplayName("display the name of the test")
        @Disabled
        ...
        void should_ReturnCoderWithWorstBMI_When_CoderListNotEmpty() {
            ...
            coders.add(new Coder(1.82, 98));  //worst BMI
        ...
        @Test
        void should_ReturnCoderWithWorstBMIIn1M_When_CoderListHas10000Elements() {
    ...
    class GetBMIScoreTests {
        @Test
        void should_ReturnNullWithWorstBMI_When_CoderListNotEmpty() {
            //given
            List<Coder> coders = new ArrayList<>();
            coders.add(new Coder(1.80, 60));
            coders.add(new Coder(1.82, 98));  //worst BMI
